 ...
 */
final class Version20240514012243 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE car_availability (availability_id INT NOT NULL, car_id INT NOT NULL, INDEX IDX_666E1D5761778466 (availability_id), INDEX IDX_666E1D57C3C6F69F (car_id), PRIMARY KEY(availability_id, car_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
